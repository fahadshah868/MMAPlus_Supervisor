...
MobileBuiltInKeywords.verifyElementText(findTestObject('ModuleSelectionScreenElements/WW/ShopOpen/ChillerUtilization/ShopKeeperDidNotAllow/Validate_CategoryRemarksScreen'), 
    'CATEGORY REMARKS')

MobileBuiltInKeywords.tap(findTestObject('ModuleSelectionScreenElements/WW/ShopOpen/ChillerUtilization/ShopKeeperDidNotAllow/CategoryRemarks_Others'), 
    0)

MobileBuiltInKeywords.tap(findTestObject('ModuleSelectionScreenElements/WW/ShopOpen/ChillerUtilization/ShopKeeperDidNotAllow/CategoryRemarks_BackButton'), 
    0)
