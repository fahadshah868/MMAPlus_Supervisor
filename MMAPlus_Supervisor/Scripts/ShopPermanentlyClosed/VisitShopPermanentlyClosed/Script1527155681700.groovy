...
'tap on "Shop Permanentle Closed" option from shop actions list'
MobileBuiltInKeywords.tap(findTestObject('ShopPermanentlyClosed/ShopPermanentlyClosed' , [('package') : ProjectConstants.PACKAGENAME]), 0)
