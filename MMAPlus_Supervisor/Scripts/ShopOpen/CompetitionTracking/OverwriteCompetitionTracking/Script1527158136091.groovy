...
'validate "Competition Tracking" detail screen appearance'
MobileBuiltInKeywords.verifyElementExist(findTestObject('ShopOpen/CompetitionTracking/Validate_CompetitionTrackingScreen' , [('package') : ProjectConstants.PACKAGENAME]), 
    0)

'overwrite competition tracking products'
